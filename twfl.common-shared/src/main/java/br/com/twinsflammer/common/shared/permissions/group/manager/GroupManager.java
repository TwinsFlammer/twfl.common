...
public class GroupManager {
    ...
    public GroupManager() {
        ...
        if (groups1.isEmpty()) {
            Group MASTER = GroupManager.generateGroup(1, GroupNames.MASTER, "[Master] ", "", "6", 100, 1, -1L, 0),
                    ...
                    NOBLE = GroupManager.generateGroup(7, GroupNames.NOBLE, "[Nobre] ", "", "4", 70, 7, -1L, 0),
                    KNIGHT = GroupManager.generateGroup(8, GroupNames.KNIGHT, "[Cavaleiro] ", "", "3", 65, 8, -1L, 0),
                    FARMER = GroupManager.generateGroup(9, GroupNames.FARMER, "[Camponês] ", "", "9", 60, 9, -1L, 0),
