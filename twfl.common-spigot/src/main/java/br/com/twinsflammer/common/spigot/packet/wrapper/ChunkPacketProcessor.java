/**
 * This file is part of PacketWrapper. Copyright (C) 2012-2015 Kristian S.
 * Strangeland Copyright (C) 2015 dmulloy2
 *
 * PacketWrapper is free software: you can redistribute it and/or modify it
 * under the terms of the GNU Lesser General Public License as published by the
 * Free Software Foundation, either version 3 of the License, or (at your
 * option) any later version.
 *
 * PacketWrapper is distributed in the hope that it will be useful, but WITHOUT
 ...
 */
package br.com.twinsflammer.common.spigot.packet.wrapper;
...
public class ChunkPacketProcessor {
    ...
    public void process(ChunkletProcessor processor) {
        ...
        size = BYTES_PER_NIBBLE_PART * ((NIBBLES_REQUIRED + skylightCount) * chunkSectionNumber
                + extraSectionNumber)
